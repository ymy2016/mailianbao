...
typedef void(^MG_NetworkCacheCompletionBlock)(BOOL result);

@interface MG_NetworkCache : NSObject
 ...
 */
+(void)save_asyncJsonResponseToCacheFile:(id)jsonResponse andURL:(NSString *)URL completed:(nullable MG_NetworkCacheCompletionBlock)completedBlock;
 ...
 *  @param completedBlock  异步完成回调(主线程回调)
 */
+(void)save_asyncJsonResponseToCacheFile:(id)jsonResponse andURL:(NSString *)URL params:(nullable NSDictionary *)params completed:(nullable MG_NetworkCacheCompletionBlock)completedBlock;
