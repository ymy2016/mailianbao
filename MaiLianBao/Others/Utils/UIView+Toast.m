...
//
//
//  Created by Toast on 15/6/24.
//  Copyright (c) 2015年 Toast. All rights reserved.
//
...
// general appearance
static const CGFloat CSToastMaxWidth            = 0.5;      // 80% of parent view width
static const CGFloat CSToastMaxHeight           = 0.8;      // 80% of parent view height
static const CGFloat CSToastHorizontalPadding   = 16.0;
static const CGFloat CSToastVerticalPadding     = 12.0;
static const CGFloat CSToastTopBottomOffset     = 40.0;
...
//- (CGSize)sizeForString:(NSString *)string font:(UIFont *)font constrainedToSize:(CGSize)constrainedSize lineBreakMode:(NSLineBreakMode)lineBreakMode __attribute__ ((deprecated("use - (CGSize)sizeForString:(NSString *)string font:(UIFont *)font constrainedToSize:(CGSize)constrainedSize")));
...
- (void)makeToast:(NSString *)message {
    [self makeToast:message duration:CSToastDefaultDuration position:CSToastCenterPosition];
}
...
//    return [string sizeWithFont:font constrainedToSize:constrainedSize lineBreakMode:lineBreakMode];
    return [string boundingRectWithSize:constrainedSize andFont:font];
}
*/
...
- (CGSize)sizeForString:(NSString *)string font:(UIFont *)font constrainedToSize:(CGSize)constrainedSize
{
    ...
    return [string boundingRectWithSize:constrainedSize
...
- (UIView *)viewForMessage:(NSString *)message title:(NSString *)title image:(UIImage *)image {
    ...
    if (title != nil) {
        ...
        CGSize expectedSizeTitle = [self sizeForString:title font:titleLabel.font constrainedToSize:maxSizeTitle];
    ...
    if (message != nil) {
        ...
        CGSize expectedSizeMessage = [self sizeForString:message font:messageLabel.font constrainedToSize:maxSizeMessage];
