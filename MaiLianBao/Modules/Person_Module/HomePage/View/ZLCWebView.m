...
- (BOOL)canGoBack
{
    return self.wkWebView ? self.wkWebView.canGoBack : self.uiWebView.canGoBack;
}

- (void)goBack
{
    self.wkWebView ?  [self.wkWebView goBack] : [self.uiWebView goBack];
}

- (void)reload
{
    self.wkWebView ?  [self.wkWebView reload] : [self.uiWebView reload];
}
...
- (void)setProgressTop:(CGFloat)progressTop
{
    _progressTop = progressTop;
    [self.progressView setTop:progressTop];
}
